...
from benchmarking.b_path_manager import pfo_output_A6_BNR, pfo_adni
...
integrators within NiftyReg. We want to see if using an improved numerical exponential has any positive and significant
effect in the whole pipeline. 
Again we use 
"""
...
if __name__ == '__main__':
    ...
    control = {'generate_dataset_aff'  : True,
               'measure_nrig_step'     : True,
               'get_statistics'        : True,
               'show_graphs'           : True}

    verbose = 1
    pfo_nifty_reg_app_vanilla = ''
    pfo_nifty_reg_source_vanilla = ''

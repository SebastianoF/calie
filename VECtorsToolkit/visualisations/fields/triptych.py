...
def volume_quiver_volume(volume_1,
                         input_vf,
                         volume_2,
                         fig_tag=6,
                         input_fig_size=(15, 5),
    ...
    if anatomical_plane == 'axial':
        ax_1.imshow(volume_1[:, :, h_slice], interpolation=interpolation, origin=origin, cmap=cmap)
    ...
    if anatomical_plane == 'axial':
        ax_3.imshow(volume_1[:, :, h_slice], interpolation=interpolation, origin=origin, cmap=cmap)

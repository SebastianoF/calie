...
path_t0_nifti = jph(path_to_folder, '1305_T1.nii.gz')
path_t0_nifti = jph(path_to_folder, '1702_T1.nii.gz')

path_to_svf = jph(path_to_folder, 'vel_cpp_disp.nii.gz')

path_output_img = jph(path_to_folder, 'output_img_z')
...
os.system("convert -delay 0.1 -dispose Background +page " + str(path_output_img)

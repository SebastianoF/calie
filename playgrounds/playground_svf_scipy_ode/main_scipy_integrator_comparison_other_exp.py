...
#sdisp_ser     = svf_0.exponential(algorithm='series', s_i_o=spline_interpolation_order)
...
sdisp_vode    = svf_0.exponential_scipy(verbose=True, passepartout=passepartout)
...
print '|vode - disp|      = ' + str((sdisp_vode - sdisp_0).norm(passe_partout_size=passepartout+1))

...
filename_errors = 'file_error_1_40_5_steps_all_methods_linear'
filename_times  = 'file_time_1_40_5_steps_all_methods_linear'
        ...
        for integrator_i in range(len(integrators)):
            for max_step_i in range(len(max_steps)):
                ...
                if verbose or verbose_logorrheic:
                    ...
                    print 'integrator method : ' + str(integrators[integrator_i])
                ...
                sdisp_scipy =  svf_0.exponential_scipy(integrator=integrators[integrator_i],
                                                       method='adams',

...
if __name__ == "__main__":
    ...
    saved_file_index = '1_k_5_n_120'

    path_to_parameters  = os.path.join(path_to_folder, 'step_error_parameters_multiple_gauss_' + str(saved_file_index) + '.npy')
    path_to_step_errors = os.path.join(path_to_folder, 'step_error_errors_multiple_gauss_'     + str(saved_file_index) + '.npy')
    ...
    n = 120  # maximal number of consecutive steps where to compute the truncation error
    ...
    methods_color_list = ['b', 'g', 'r', 'c', 'm', 'y', 'k', '0.6', 'g', 'r']
    ...
    plot_multiple_graphs(range(0, n), step_errors[0:, :, :], methods_titles=methods_names_list,
                         ...
                         window_title_input='step errors for multiple random gauss svf elements 120 steps 10 svfs')

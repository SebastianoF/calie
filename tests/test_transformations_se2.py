...
def test_init_se2_a_random_input():
    ...
    assert_array_equal(se2.Se2A(any_angle_in_pi_pi, any_tx, any_ty).get,
...
def test_se2_a_get_matrix_det():
    ...
    assert round(np.abs(given_output-expected_output), meaningful_decimals) == 0.0
...
def test_se2_a_quotient_projection_greater_than_pi():
    ...
    tx_out = tx_in * fact
    ty_out = ty_in * fact
    assert_array_equal(se2.Se2A(theta_in, tx_in, ty_in).get, se2.Se2A(theta_out, tx_out, ty_out).get)
...
def test_se2_a_quotient_peojection_smaller_than_pi():
    ...
    tx_in = 3
    ty_in = 4
    assert_array_equal(se2.Se2A(theta_in, tx_in, ty_in).get, [theta_in, tx_in, ty_in])
...
def test_se2_a_add_0_translation():
    ...
    given_output = (se2.Se2A(any_angle_1, tx_1, ty_1) + se2.Se2A(any_angle_2, tx_2, ty_2)).get
...
def test_se2_a_add_0_rotation():
    ...
    expected_output = [expected_output_angle, expected_output_tx, expected_output_ty]
    given_output = (se2.Se2A(angle_1, any_tx_1, any_ty_1) + se2.Se2A(angle_2, any_tx_2, any_ty_2)).get
    assert_array_equal(given_output, expected_output)
...
def test_se2_a_norm_standard_fixed_input_non0():
    angle, tx, ty = se2.Se2A(4, 5, 6).quot.get  # input data has to be considered in the quotient space
    lamb = 1
    element = se2.Se2A(angle, tx, ty)
    assert_equal(element.norm('lamb', lamb), np.sqrt(angles.mod_pipi(angle)**2 + lamb*(tx**2 + ty**2)))
...
def test_se2_a_is_a_matrix_in_se2_a_bad_shape_input():
    tt = np.array([1, 2, 3])
    assert not se2.is_a_matrix_in_se2a(tt)
...
def test_se2_a_is_a_matrix_in_se2_a_good_input():
    ...
    assert se2.is_a_matrix_in_se2a(tt)
...
def test_se2_a_lie_bracket_insane_input():
    ...
    with assert_raises(Exception):
        se2.se2a_lie_bracket(element1, element2)
...
def test_se2_a_lie_multi_bracket():
    ...
    ans_expected = se2.se2a_lie_bracket(elem1, se2.se2a_lie_bracket(elem2, se2.se2a_lie_bracket(elem3, elem4))).get
...
def test_se2_a_scalarpr_smaller_than_pi():
    ...
    expected_ans = se2.Se2A(scalar * any_angle_1, scalar * any_tx_1, scalar * any_ty_1)
...
def test_se2_a_scalarpr_greater_than_pi():
    ...
    # (scalar * elem).quot :
    expected_ans = se2.Se2A(scalar * elem_quot_get[0], scalar * elem_quot_get[1], scalar * elem_quot_get[2])
    # scalar * (elem.quot) :
...
def test_init_se2_g_random_input():
    ...
    any_tx = uniform(-10, 10)
    any_ty = uniform(-10, 10)
    assert_array_equal(se2.Se2G(any_angle_in_pi_pi, any_tx, any_ty).get, [any_angle_in_pi_pi, any_tx, any_ty])
...
def test_se2_g_mul_0_translation():
    ...
    expected_output_ty = 0
    expected_output = [expected_output_angle, expected_output_tx, expected_output_ty]
    given_output = (se2.Se2G(any_angle_1, tx_1, ty_1) * se2.Se2G(any_angle_2, tx_2, ty_2)).get
    assert_array_equal(given_output, expected_output)
...
def test_se2_g_mul_0_rotation():
    ...
    expected_output_ty = any_ty_1 + any_ty_2
    expected_output = [expected_output_angle, expected_output_tx, expected_output_ty]
    given_output = (se2.Se2G(angle_1, any_tx_1, any_ty_1) * se2.Se2G(angle_2, any_tx_2, any_ty_2)).get
    assert_array_equal(given_output, expected_output)
...
def test_se2_g_mul_random_input():
    ...
    expected_output = [expected_output_angle, expected_output_tx, expected_output_ty]
    given_output = (se2.Se2G(any_angle_1, any_tx_1, any_ty_1) * se2.Se2G(any_angle_2, any_tx_2, any_ty_2)).get
    assert_array_equal(given_output, expected_output)
...
def test_se2_g_norm_standard_fixed_input_non0():
    ...
    lamb = 1
    element = se2.Se2G(angle, tx, ty)
    assert_equal(element.norm('standard', lamb), np.sqrt(angles.mod_pipi(angle)**2 + lamb*(tx**2 + ty**2)))
...
def test_se2_se2g_randomgen_standard_insane_interval():
    interval = (1, 2, 3)
    with assert_raises(Exception):
        se2.se2g_randomgen(interval)


def test_se2_se2g_randomgen_standard_negative_interval():
    interval = (1, -2)
    with assert_raises(Exception):
        se2.se2g_randomgen(interval)
...
def test_se2_se2g_randomgen_standard_a_negative_interval():
    interval = (-3, 1)
    with assert_raises(Exception):
        se2.se2g_randomgen(interval)
...
def test_se2_se2g_randomgen_standard_lamb_0_no_restriction_interval_sx():
    a = 0
    b = 2
    lamb = 0
    interval = (a, b)
...
def test_se2_se2g_randomgen_translation_negative_interval():
    interval = (-1, -2)
    with assert_raises(Exception):
        se2.se2g_randomgen_translation(interval)
...
def test_se2_se2g_randomgen_translation_a_negative_interval():
    interval = (-3, 1)
    with assert_raises(Exception):
        se2.se2g_randomgen_translation(interval)
...
def test_se2_se2g_randomgen_fro_negative_interval():
    interval = (-1, -2)
    with assert_raises(Exception):
        se2.se2g_randomgen_fro(interval)
...
def test_se2_se2g_randomgen_fro_a_negative_interval():
    interval = (-3, 1)
    with assert_raises(Exception):
        se2.se2g_randomgen_fro(interval)
...
def test_se2_g_is_a_matrix_in_se2_g_bad_shape_input():
    tt = np.array([1, 2, 3])
    assert not se2.is_a_matrix_in_se2g(tt)
...
def test_se2_g_is_a_matrix_in_se2_g_good_input():
    tt = np.array([[1, 2, 0], [-2, 1, 0], [0, 0, 1]])
    assert se2.is_a_matrix_in_se2g(tt)
